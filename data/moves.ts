...
export const Moves: import('../sim/dex-moves').MoveDataTable = {
	...
	courtchange: {
		...
		onHitField(target, source) {
			const sideConditions = [
				'mist', 'lightscreen', 'reflect', 'spikes', 'safeguard', 'tailwind', 'toxicspikes', 'stealthrock', 'waterpledge', 'firepledge', 'grasspledge', 'stickyweb', 'torchtrap', 'auroraveil', 'gmaxsteelsurge', 'gmaxcannonade', 'gmaxvinelash', 'gmaxwildfire',
			];
			let success = false;
	...
	defog: {
		...
		onHit(target, source, move) {
			...
			const removeTarget = [
				'reflect', 'lightscreen', 'auroraveil', 'safeguard', 'mist', 'spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'torchtrap', 'gmaxsteelsurge',
			];
			const removeAll = [
				'spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'torchtrap', 'gmaxsteelsurge',
			];
	...
	gmaxwindrage: {
		...
		self: {
			onHit(source) {
				let success = false;
				const removeTarget = [
					'reflect', 'lightscreen', 'auroraveil', 'safeguard', 'mist', 'spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'torchtrap',
				];
				const removeAll = ['spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'torchtrap', 'gmaxsteelsurge'];
				for (const targetCondition of removeTarget) {
	...
	mortalspin: {
		...
		onAfterHit(target, pokemon, move) {
			if (!move.hasSheerForce) {
				...
				const sideConditions = ['spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'torchtrap', 'gmaxsteelsurge'];
